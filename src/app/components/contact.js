    ...
    <div id="contact">
      ...
      <ThemeProvider theme={darkTheme}>
        ...
        <Container component="main" maxWidth="sm" sx={{ boxShadow: 3, mb: 4 }}>
          <Paper
            variant="outlined"
            sx={{ boxShadow: 3, my: { xs: 3, md: 6 }, p: { xs: 2, md: 3 } }}
          >
            ...
            {activeStep === steps.length ? (
              <React.Fragment>
                <Typography variant="h5" gutterBottom>
                  ...
                  <img src="/cele.svg" height={29} width={29} />.
                </Typography>
                <Typography variant="subtitle1">
                  {/* I will replay you as soon as I read your Message :) */}
                  Note : Your message is not sent because i have not connected
                  backend server till now.
                  <br />
